...
<!-- Breadcrumbs Start
	...
	<section id="topic-header">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<h1>Tips for wine pairing</h1>
					<p>Learn all the little secrets</p>
				</div>	<!-- End of /.col-md-4 -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9 clearfix">
					<ol>
						<li><h4>1. The wine should be more acidic than the food.</h4></li>								
						<li><h4>2. The wine should be sweeter than the food.</h4></li>					
						<li><h4>3. The wine should have the same flavor intensity as the food.</h4></li>									
						<li><h4>4. Red wines pair best with bold flavored meats (e.g. red meat).</h4></li>										
						<li><h4>5. White wines pair best with light-intensity meats (e.g. fish or chicken).</h4></li>									
						<li><h4>6. Bitter wines (e.g. red wines) are best balanced with fat.</h4></li>									
						<li><h4>7. It is better to match the wine with the sauce than with the meat.</h4></li>								
						<li><h4>8. More often than not, White, Sparkling and Rosé wines create contrasting pairings.</h4></li>										
						<li><h4>9. More often than not, Red wines will create congruent pairings.</h4></li>	
						<li>Tips from <a href=https://winefolly.com/>winefolly</a></li>	
					</ol>
				...
				<div class="col-md-3">
					<div class="blog-sidebar">
						...
						<div class="block">
							...
							<ul class="media-list">
							 	<li class="media">
							    	<a class="pull-left" href="meatCategory.php">
							      		<img class="media-object" src="images/steak.jpg" alt="...">
							    	</a>
							    	<div class="media-body">
							      		<a href="meatCategory.php" class="media-heading">
							      			Meats</a>
							    	  	<p>Steak,Lamp,Chicken,etc...</p>
							    	</div>
							  	</li>
							  	<li class="media">
							    	<a class="pull-left" href="seafoodCategory.php">
							      		<img class="media-object" src="images/seafood.jpg" alt="...">
							    	</a>
							    	<div class="media-body">
							      		<a href="seafoodCategory.php" class="media-heading">
							      			Seafood</a>
							    	  	<p>Lobster,Salmon,Oysters,etc...</p>
							    	</div>
							  	</li>
							  	<li class="media">
							    	<a class="pull-left" href="pastaCategory.php">
							      		<img class="media-object" src="images/pasta.jpg" alt="...">
							    	</a>
							    	<div class="media-body">
							      		<a href="pastaCategory.php" class="media-heading">
							      			Pasta</a>
							    	  	<p>Carbonara,Spaghetti Bolognaise,Lasagne,etc...</p>
							    	</div>
							  	</li>
							  </ul>
						</div>	<!-- End of /.block -->
