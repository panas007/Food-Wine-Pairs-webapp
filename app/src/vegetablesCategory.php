...
<!-- TOP HEADER Start
	...
	<section id="topic-header">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<h1>Vegetables Category</h1>
					<p>Select & pair</p>
				</div>	<!-- End of /.col-md-4 -->	
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
					  	<li><a href="index.php">Home</a></li>
					  	<li class="active">vegetablesCategory</li>
					</ol>
				</div>	<!-- End of /.col-md-8 -->
			</div>	<!-- End of /.row -->
		</div>	<!-- End of /.container -->
					        ...
					        <div class="blog-box">
					            ...
					            <div class="blog-post-body clearfix">
						            <a href="vegetablesCategory.php">
					            		<h2>Select your favorite Vegatable or Fruit</h2>
						            </a>
						            <p>Here you can see the perfect pairings for different vegetables</p>
									</br></br>
