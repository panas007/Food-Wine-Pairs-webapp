			...
			<div class="row">
				...
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
					  	<li><a href="index.php">Home</a></li>
					  	<li class="active">seafoodCategory</li>
					</ol>
				</div>	<!-- End of /.col-md-8 -->
			</div>	<!-- End of /.row -->
		</div>	<!-- End of /.container -->
					        ...
					        <div class="blog-box">
					            ...
					            <div class="blog-post-body clearfix">
						            <a href="seafoodCategory.php">
					            		<h2>Select your favorite Seafood</h2>
						            </a>
						            <p>Here you can see the perfect pairings for different Seafoods</p>
									</br></br>
									...
									<div class="box col-md-5 clearfix">
									  <select id="selbox" class="ddlCars">
									  	<option>Lean and Flaky Fish</option>
										<option>Medium-Textured Fish</option>
										<option>Meaty Fish</option>
										<option>Strongly Flavored Fish</option>
										<!--<option>Sea bass</option>
										<option>Branzino</option>
