...
<!-- TOP HEADER Start
	...
	<section id="topic-header">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<h1>Pasta Category</h1>
					<p>Select & pair</p>
				</div>	<!-- End of /.col-md-4 -->	
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
					  	<li><a href="index.php">Home</a></li>
					  	<li class="active">pastaCategory</li>
					</ol>
				</div>	<!-- End of /.col-md-8 -->
			</div>	<!-- End of /.row -->
		</div>	<!-- End of /.container -->
					    ...
					    <li>
					        ...
					        <div class="blog-box">
					            ...
					            <div class="blog-post-body clearfix">
						            <a href="seafood.php]">
					            		<h2>Select your favorite Pasta</h2>
						            </a>
						            <p>Here you can see the perfect pairings for different pastas</p>
									</br></br>
